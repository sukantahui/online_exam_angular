...
const routes: Routes = [{ path: '', component: PythonTutorialComponent,
  children: [
    ...
    { path: 'pythonTuples', loadChildren: () => import('./python-tuples/python-tuples.module').then(m => m.PythonTuplesModule) },
    { path: 'MysqlConnection', loadChildren: () => import('./mysql-connection/mysql-connection.module').then(m => m.MysqlConnectionModule) },
